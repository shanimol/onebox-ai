...
class RightDrawer extends StatefulWidget {
  ...
  const RightDrawer({super.key, required this.controller});
    ...
    return Scaffold(
      ...
      body: Container(
        decoration: BoxDecoration(
          color: AppColors.nexusBg,
          boxShadow: [
            BoxShadow(
              color: AppColors.gray19.withOpacity(.2),
              blurRadius: 10,
              spreadRadius: 5,
            ),
          ],
        ...
        child: Container(
          decoration: BoxDecoration(
            color: AppColors.nexusBg,
            border: Border.all(color: AppColors.gray01.withOpacity(1)),
          ),
                ...
                child: AspectRatio(
                  ...
                  child: IndexedStack(
                    ...
                    children: [
                      ...
                      Calendar(controller: widget.controller),
                    ],
                  ),
                ),
              ),
